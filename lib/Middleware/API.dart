...
import 'package:insulin_app_flutter/model/CityModel.dart';
import 'package:insulin_app_flutter/model/ProFileModel.dart';
import 'package:insulin_app_flutter/model/StateModel.dart';
import 'package:insulin_app_flutter/model/WeightModel.dart';
import 'package:insulin_app_flutter/model/SearchFoodMeal.dart';
      ...
      SnackBar(
          ...
          content: Center(
           ...
           _notifyUser('FOOD LOGGED');
                print(  ' api hitting ${Provider.of<NutritionChartNotifier>(context, listen: false)}');
